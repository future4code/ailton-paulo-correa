...
export class UserBusiness {
  ...
  public signup = async (input: ISignupInputDTO) => {
    ...
    if (isEmailAlreadyExists) throw new ConflictError("Email já cadastrado");
  ...
  public login = async (input: ILoginInputDTO) => {
    ...
    if (!userDB) throw new NotFoundError("Email não cadastrado");
    ...
    if (!isPasswordCorrect) throw new AuthenticationError("Password incorreto");
